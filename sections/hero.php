<section class="hero">
  ...
  <div class="hero-bg">
    <!-- OPTION 1: Image -->
    <img src="images/school.jpg" alt="School Campus">
  ...
  <div class="hero-content">
    <h1>
      An AI-Powered, Future-Ready School <br>
      with a Next-Gen Learning Approach
    </h1>

    <p>
      A CBSE-based, co-educational, structured learning environment that blends 
